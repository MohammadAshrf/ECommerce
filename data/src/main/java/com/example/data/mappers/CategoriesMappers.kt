...
//}
//
//fun Category.toEntity(): com.example.domain.entity.category.Category {
//    return com.example.domain.entity.category.Category(id, createdAt, image, name, slug, updatedAt)
//}
//
