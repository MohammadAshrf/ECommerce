package com.example.ecommerce.ui.home.tabs.categories.productDetails
...
class ProductDetailsSliderAdapter(imageUrl: List<String>) :
    SliderViewAdapter<ProductDetailsSliderAdapter.SliderViewHolder>() {
